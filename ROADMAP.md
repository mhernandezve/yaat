...
- [x] Add **commitlint** job to CI (`wagoid/commitlint-github-action`)
- [x] Configure **Release Please** for automated versioning
  - `release-type: rust`
...
- [x] Pre-compiled binaries via GitHub Releases (managed by cargo-dist)
- [x] Installer script generated by cargo-dist for bootstrap usage
